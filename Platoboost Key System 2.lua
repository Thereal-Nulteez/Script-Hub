-- [[ Nulteez Hub - UNIVERSAL SECURE KEY SYSTEM ]]
-- Support: https://discord.gg/v4ku368Hma
...
local Config = {
    ...
    ServiceId       = 21850, -- Your PlatoBoost Service ID
    PlatoSecret     = "b82c839f-cd39-4b49-a3d0-fbbfbbfb66cb", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "NulteezHub1002", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    ...
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/v4ku368Hma",
    
    ShowInstagram   = true,
    InstagramURL    = "https://www.instagram.com/oyb0i/",
    
    ShowYoutube     = true,
    YoutubeURL      = "https://www.youtube.com/@ProdbyNulteez",

    -- [5] File System
    KeyFileName     = "NulteezKey.txt", -- The name of the file where the valid key will be saved for auto-login

    -- [6] GUI Management
    OldGuiName      = "Nulteez Hub", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Nulteez Hub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Nulteez Hub Key", -- The main title shown at the top of the GUI
    HubDescription  = "Pls support me" -- The text shown below the title
}
...
local function CreateGUI()
    ...
    if targetParent:FindFirstChild("Nulteez_KeySystem") then targetParent.Nulteez_KeySystem:Destroy() end

    local ScreenGui = Instance.new("ScreenGui", targetParent)
    ScreenGui.Name = "Nulteez_KeySystem"
    ...
    Status.Text = "Waiting for input Key..."
...
if pGui:FindFirstChild(Config.MainGuiName) then
    StartMainScript(0.01) -- Run if main script is already active
    return
end
